                ...
                >
                    {props => {
                        return  (<>
                            ...
                            <Select label="Severity" name="severity" id="severity">
                                <option value="" disabled>--- Select severity ---</option>
                                {
                                    props.severities.map(severity => <option value={severity.level} key={severity.level}>{severity.name}</option>)
                                }
                            </Select>
                            <Checkbox label="Vulnerability" name="vulnerability" id="vulnerability" />
                            <Select label="Module" name="module" id="module">
